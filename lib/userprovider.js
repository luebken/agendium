...
UserProvider = function(){
    ...
    console.log('Connecting to uri.auth '+uri.auth+'@'+uri.hostname + ':' + uri.port + '/' + uri.pathname );    
    this.db= new Db(uri.pathname, new Server(uri.auth+'@'+uri.hostname, uri.port, {auto_reconnect: true}, {}));
