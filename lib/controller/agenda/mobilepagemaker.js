...
MobilePageMaker.prototype.createList = function(page, pageid, appname) {
    var style = "";    
    if(page.color) style = 'style="background: #' + page.color + ';"'
    var pagehtml = '<div data-role="page" id="' + pageid + '"' + style + ' data-add-back-btn="true">';
    pagehtml += '<div data-role="header"><h1>' + page.title + '</h1></div>';
    if(page.logourl) {
        pagehtml += '<div class="pagelogo">';
        pagehtml += '<h1><img src="' + page.logourl + '"></h1>';
        pagehtml += '</div>';
    }
    var childhtml = '';
...
MobilePageMaker.prototype.createDetails = function(page, pageid, appname) {
    var pagehtml = '<div data-role="page" id="' + pageid + '" data-add-back-btn="true">';
    pagehtml += '<div data-role="header"><h1>' + page.title + '</h1></div>';
